...
static const unsigned char CRC16_TABH[] = 
{
...
static const unsigned char CRC16_TABL[] = 
{
...
unsigned short int  crc16_check(unsigned char *data,unsigned short int len)//CRC校验
{   
	unsigned char CRCH = 0xFF ;    // 高CRC字节初始化
	unsigned char CRCL = 0xFF ;    // 低CRC 字节初始化
	unsigned char index ;             // CRC循环中的索引
	
	for(unsigned short int i=0;i<len; i++)
	{
		index = CRCH ^ *data++ ; // 计算CRC
